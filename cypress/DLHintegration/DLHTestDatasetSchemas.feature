...
And I can select a "External link" "Table1 - code" with label field "" and linked field "table4f1" and master field "table1f2" and ignore case "" for dataflow "Reference dataflow 3"
And I change to "Tabular data" mode
And I reload the page
And I can add a record
  | 1 | link | 1 |
